...
* 개선해야 할 우선 순위 척도 (Score) = 발생 건수 * 감성 가중치 * 비즈니스 임팩트<br>
감성 가중치: 분노(5)> 불안(4)> 불만(3) >아이러니(2)> 만족/기대(1)
<br> </br> 
* 불안이 4.0이고, 불만이 3.0인 이유 <br>
보안과 직결된 VOC(12/23 명의 도용 가입 알림 의심 12/31 계좌 개설 톡 도용 의심)들이 ‘불안’으로 분류, 불만은 “짜증난다”에서 그치지만, 불안은 “내 돈이 위험하다.”, “내 정보가 털렸다.”등과 같은 개인 정보(보안)에 있어서 걱정하기 때문. 금융 앱에서 불안을 느끼는 고객은 즉시 계좌를 해지하거나 앱을 삭제하는 경향이 있음. (이탈 가능)
불만 3.0 VOC(12/11 신분증 촬영 안 됨12/29 금융사 연결 지연)기능 장애 이슈로 불만으로 분류
<br> </br>
* 비즈니스 임팩트: 보안/인증(5) > 심사 정합성(4)> 고객 상담(3)> 일반 기능 탐색(2)

보안 및 인증 - 보안 사고나 인증 실패와 같은 경우 입구가 막히거나 브랜드 자체의 매우 큰 리스크이기 때문에

심사 정합성(4)는 핀다 서비스의 본질적인 가치로 ‘정확한 대출 정보를 제공'하기 때문. VOC(12/15 통장 계좌 개설 후 최종 거절 사례와 12/24 ‘대출 가능 노출 후 실제 거절 서비스의 지속 가능성을 결정.

고객 상담의 경우, VOC (12/17, 12/30) 고객 상담 지연 및 무응답으로 고객을 화나게 한 경우, 감정적 타격은 크지만 기술적 결함보다는 후순위에 배치
일반 기능 탐색 부분에서 사용자가 상품을 구경하거나 추가적인 혜택을 찾는 정상적 이용 요구 영역

“서비스가 왜 이래?”, “느려 터졌네.”기능적 불만에 따른 짜증 문의.불만은 기능이 개선되거나 상담을 통해 해결 가능. 불안은 한 번 생기면 해소가 어렵기 때문에
